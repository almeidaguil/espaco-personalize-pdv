...
O workflow normal de PR continua executando lint, type-check, testes unitarios e build. O E2E fica manual porque usa Supabase real, usuario real e pode criar dados operacionais.
